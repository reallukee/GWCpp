...
namespace GWCpp
{
	...
	public:
		...
		*/
		...
		bool SuspendWindow()
		{
			if (WindowStarted && !WindowClosed && !WindowSuspended)
			{
				try
				{
					GWCThread->Suspend();
	...
	private:
		...
		String^ FontName_ = "Comic Sans MS";
